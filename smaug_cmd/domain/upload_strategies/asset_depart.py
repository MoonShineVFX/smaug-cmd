...
class AssetDepartUploadStrategy(BaseUploadStrategy):
    def upload_previews(self, asset_template: AssetTemplate, upload_user: str):
    ...
    def upload_textures(self, asset_template: AssetTemplate, upload_user: str):
    ...
    def upload_3d_preview(self, asset_template: AssetTemplate, upload_user: str):
        asset_id = asset_template["id"]
        if asset_id is None:
            raise ValueError("Asset id is None")
